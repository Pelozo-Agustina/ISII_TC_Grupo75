...
<section class="seccion-contenedor">
        ...
        <div class="container tarjeta-cafe">
                    ...
                    <tbody>
                        <tr>
                            <td class="col-atenuada" style="text-align: center; padding: 40px;">
                                <h2 class="titulo-seccion" style="font-size: 22px; margin-bottom: 15px;">No hay Productos</h2>
            ...
            <?php if( ($this->session->userdata('login_in')) and ($session_data['perfil_id']=='1') ) { ?>
                <div class="contenedor-acciones-top" style="margin-top: 20px; justify-content: center;">
                    <a class="btn-cafe-solido" href="<?php echo base_url('cargar_producto'); ?>">Agregar</a>
                    <a class="btn-cafe-solido btn-rojo-suave" href="<?php echo base_url('productos_eliminados'); ?>">ELIMINADOS</a>
                </div>
            <?php } ?>  
        </div>
    ...
    <?php } else { ?>
        ...
        <div class="container tarjeta-cafe">
            ...
            <!-- Botones Agregar / Eliminados superiores, ovalados y claros -->
                ...
                <table class="tabla-estilo-cafe">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <?php
                                // PATRÓN STATE: instanciar según valor del campo en BD
                                // La vista no pregunta si eliminado=='SI', le pregunta al objeto
                            ...
                            <td>
                                <div class="grupo-acciones">
                                    ...
                                    <?php if ($estadoProducto->estaActivo()): ?>
                                        <!-- estaActivo() == true → ProductoActivo: mostrar Eliminar -->
                                        <a class="btn-pildora btn-accion-eliminar"
                                           href="<?php echo base_url("producto_elimina/$row->id"); ?>"
                                           onclick="return confirm('¿Desactivar este producto?')">
                                            Eliminar
                                        </a>
                                    <?php else: ?>
                                        <!-- estaActivo() == false → ProductoInactivo: mostrar Activar -->
                                        <a class="btn-pildora btn-accion-activar"
                                           href="<?php echo base_url("productos_activa/$row->id"); ?>"
...
<style>
    ...
    /* Ancho compacto controlado para evitar desalineación */
