...
<section class="seccion-contenedor">
    ...
    <?php } else { ?>
         ...
         <div class="container tarjeta-cafe">
            <!-- Título Principal -->
            <h1 class="titulo-seccion">Todos los Productos Para Acompañar</h1>
 
            <!-- Botón Agregar Superior (Estilo Óvalo Claro) -->
...
<!-- ========================================== -->
<!--ESTILOS DE LA COMPAÑÍA (PARA ACOMPAÑAR) -->
<!-- ========================================== -->
<style>
    .seccion-contenedor {
    ...
    /* Ancho compacto controlado para evitar que los botones se separen */
