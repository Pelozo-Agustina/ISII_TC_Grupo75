...
<section class="seccion-contenedor">
    ...
    <?php } else { ?>
         ...
         <div class="container tarjeta-cafe">
            <!-- Título Principal -->
            <h1 class="titulo-seccion">Todas las Bebidas Frías</h1>
...
<!-- ========================================== -->
<!-- 🎨 ESTILOS DE LA COMPAÑÍA (BEBIDAS FRÍAS)   -->
<!-- ========================================== -->
<style>
    .seccion-contenedor {
    ...
    /* 🚨 FIJA EL ANCHO COMPACTO EN LA COLUMNA DE ACCIONES */
